...
const base=path.resolve(__dirname,'..'),files=['motion','model','engine','view','report','scene','blender-models','app'];
...
const target=path.resolve(base,'../직선RGV_실행.html');write(target,html);write(path.join(base,'qa/build-manifest.json'),JSON.stringify(manifest,null,2));
