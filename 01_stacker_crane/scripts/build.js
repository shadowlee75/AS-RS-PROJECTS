...
const files = ['vendor/three.min.js', 'vendor/OrbitControls.js', 'src/motion.js', 'src/model.js', 'src/engine.js', 'src/report.js', 'src/charts.js', 'src/print.js', 'src/scene.js', 'src/blender-models.js', 'src/app.js', 'src/help.js'];
