...
assert.deepEqual([...modules.keys()],['three.min','OrbitControls','motion','model','tables','engine','view','report','xlsx','excel','scene','blender-models','app']);
...
fs.writeFileSync(path.join(base,'qa/shipcheck.json'),JSON.stringify(result,null,2));console.log('SHIPCHECK '+checks.length+' groups, '+modules.size+' inline modules, SHA256 matched.');
